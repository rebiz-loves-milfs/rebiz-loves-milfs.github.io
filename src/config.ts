export const SITE = {
  ...
  description:
    "A personal blog where Rebiz writes about life, anime, frontend development, and everything in between — come along for the journey.",
  author: "Rebiz",
...
export const MUSIC_QUOTES = [
  ...
  {
    text: "Music is a moral law. It gives soul to the universe, wings to the mind, flight to the imagination.",
    author: "Plato",
  },
  {
  ...
  {
    text: "To stop the flow of music would be like the stopping of time itself, incredible and inconceivable.",
