...
export const siteConfig: SiteConfig = {
	...
	anilist: {
		username: "notreejit",
		fetchOnDev: true,
		url: "https://anilist.co/user/notreejit/",
	},
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to the blog! This is a sample announcement.", // announcement content
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	mode: "youtube-iframe",
	// Set either a YouTube playlist ID or a single video ID
	youtubePlaylistId: "PLPWMX0C4Km7oIE1dxqTXvFYI1qir7TTY8",
	//youtubeVideoId: "GdQYn6YaiPc", // Single YouTube video ID (from https://youtu.be/GdQYn6YaiPc)
	// Optional: Set a custom cover image URL (overrides YouTube thumbnail)
...
export const lastFmConfig: LastFmConfig = {
	enable: true,
	username: "reejit",
	apiKey: "92acdd128fb70e10fd1352df9334c22e",
	recentTracksLimit: 5,
	pollInterval: 30000,
};

export const discordStatusConfig: DiscordStatusConfig = {
	enable: true,
	userId: "1296550727652610189",
	useWebSocket: true,
};

export const guestbookConfig: GuestbookConfig = {
	enable: true,
	supabaseUrl: "https://iamioawcknplsunxucem.supabase.co",
	supabaseKey: "sb_publishable_jZ4-zpjuekptyescINIQWw_sKew3Iqf",
	adminPassword: "mizuki-admin", // Change this to your preferred password
	maxNameLength: 50,
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	components: {
		...
		right: ["music-sidebar", "lastfm", "site-stats", "calendar", "categories"],
		drawer: [
			"profile",
			"announcement",
			"music-sidebar",
