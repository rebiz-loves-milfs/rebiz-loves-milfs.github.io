...
export const en: Translation = {
	...
	[Key.animeEmptyAniList]:
		"Please check AniList configuration or network connection",
	[Key.animeConfigAniList]:
		"Please set your AniList username in the src/config.ts file",
	...
	// Last.fm widget
	[Key.lastFmNowPlaying]: "Now Playing",
	[Key.lastFmRecentTracks]: "Recent Tracks",
	[Key.lastFmNotPlaying]: "Nothing playing right now",
	[Key.lastFmLoading]: "Loading...",
	[Key.lastFmError]: "Unable to load tracks",

	// Discord status widget
	[Key.discordStatus]: "Discord Status",
	[Key.discordOnline]: "Online",
	[Key.discordIdle]: "Idle",
	[Key.discordDnd]: "Do Not Disturb",
	[Key.discordOffline]: "Offline",
	[Key.discordStatusLabel]: "Status",
	[Key.discordActivity]: "Activity",
	[Key.discordListeningTo]: "Listening to",
	[Key.discordLoading]: "Connecting...",
	[Key.discordError]: "Unable to connect",

	// Status page
	[Key.statusPage]: "Status",
	[Key.statusPageSubtitle]: "My live presence and recent listening activity",

	// Guestbook
	[Key.guestbook]: "Guestbook",
	[Key.guestbookSubtitle]: "Leave a message and say hi — I read every one",
	[Key.guestbookLeaveMessage]: "Leave a Message",
	[Key.guestbookName]: "Your name",
	[Key.guestbookMessage]: "Your message...",
	[Key.guestbookSubmit]: "Send Message",
	[Key.guestbookSubmitting]: "Sending...",
	[Key.guestbookSuccess]: "Message sent! Thanks for stopping by 👋",
	[Key.guestbookError]: "Failed to send. Please try again.",
	[Key.guestbookEmpty]: "No messages yet — be the first!",
	[Key.guestbookReply]: "Reply from Rebiz",
	[Key.guestbookAdminReply]: "Write a reply...",
	[Key.guestbookDelete]: "Delete",
	[Key.guestbookConfirmDelete]: "Delete this message?",
	[Key.guestbookAdminLogin]: "Admin Access",
	[Key.guestbookAdminPassword]: "Admin password",
	[Key.guestbookAdminUnlock]: "Unlock",
	[Key.guestbookAdminWrongPassword]: "Wrong password, try again",
	[Key.guestbookRateLimit]: "Please wait a moment before sending another message",
	[Key.guestbookTotal]: "{count} messages",
	[Key.guestbookReplying]: "Replying...",
	[Key.guestbookReplySuccess]: "Reply sent!",
};
